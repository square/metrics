...
var (
	...
	basicList = api.SeriesList{Series: []api.Timeseries{seriesA1, seriesA2, seriesB3, seriesB4, seriesC5}}
	dcList    = api.SeriesList{Series: []api.Timeseries{seriesDC_A, seriesDC_B, seriesDC_C}}
	envList   = api.SeriesList{Series: []api.Timeseries{seriesENV_PROD, seriesENV_STAGE}}
